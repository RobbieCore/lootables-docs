...
| `server/editable/qb.lua` | Framework functions via kq_link (items, money, jobs) |
...
- **Framework functions** — Override how items are given, removed, or checked if `kq_link` doesn't cover your use case
