...
- **Proximity mode** (default): A floating text prompt appears above the box — press `E` to interact
- **Target mode**: Aim at the box to see the target option, then click to interact
